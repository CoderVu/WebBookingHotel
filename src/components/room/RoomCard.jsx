            ...
            <Card>
                <Card.Body className="d-flex flex-wrap align-items-center">
                  ...
                  <div className="flex-shrink-0 mt-3">
                    <Link to={`/book-room/${room.id}`} className="btn btn-hotel btn-sm" style={{ color: "darkgoldenrod", fontFamily: "'Courier New', Courier, monospace", fontSize: "medium" }}>View/ Book Now</Link> {/* Corrected 'bnt-sm' to 'btn-sm' */}
                  </div>
                </Card.Body>
            </Card>
        </Col>
